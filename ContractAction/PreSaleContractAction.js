...
var ContractaddressPresale = "0xdC03dba393cb3388123EF7978b165Fe32a5F1A73";
...
export const setBuyPreEVC = async (_amount) => {
  if (window.ethereum) {
    ...
    const txid = await contracts.methods.buypreEVC(_finalamount).send({ from: account, value: _finalamount });
    console.log(txid);
  }
};
